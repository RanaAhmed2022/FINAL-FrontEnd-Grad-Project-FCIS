    ...
    return (
        ...
        <header>
            <div className="logo-container">
                <Link to="/home">
                    <img className="logo" src="/assets/images/EV-Logo.png" alt="eVoting Logo" />
                </Link>
            </div>
        ...
        <section className="landing-img">
            ...
            <div className="landing-info">
                <h1 className="large-heading">Shape the Future</h1>
                <h2 className="large-heading2">Vote with Confidence!</h2>
                <p className="para">
                Every vote counts! Join us in building a brighter future by casting your vote easily and securely through our revolutionary blockchain-based platform.
                </p>
            ...
            <button className="btn" id="scrollToTop" ref={scrollTopButtonRef} onClick={scrollToTop}>
